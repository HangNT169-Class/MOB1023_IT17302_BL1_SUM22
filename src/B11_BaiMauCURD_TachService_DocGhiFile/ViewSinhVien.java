...
//        fillData(listSinhViens.size() - 1);
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        /**
         * 1. Tat ca o text file khong duoc trong 2. Tuoi phai la so nguyen
         * duong 3. Ten phai la chuoi
         */
        if (maSV.isEmpty()) {
            ...
            JOptionPane.showMessageDialog(this, "Tuoi khong duoc trong");
        } else if (diaChi.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Dia chi khong duoc trong");
            ...
            // tao 1 doi tuong SV
            SinhVien sv = new SinhVien(maSV, ten, Integer.valueOf(tuoi), diaChi, gioiTinh);
            // add vao list
